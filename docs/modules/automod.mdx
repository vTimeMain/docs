...
sidebar_position: 17
title: Automod
description: A guide to properly configure the vTime Automod for your server
keywords: [Spam, automation, invite links, caps, mention]
---

# Auto Moderation

Ensure a smooth and stress-free server environment with vTime Automod. Say goodbye to spammers and advertisers, and enjoy peace of mind knowing that vTime is working tirelessly to maintain a safe and secure environment for your community.
...
We have some detection options that are managed by the AutoMod rule in Discord, which will be indicated next to the AutoMod option. vTime will manage the ones that do not have the discord automod scanning mentioned.
...
> **SPAMMED CAPS (70% > CAPS)**: This option detects messages that are written in all caps, like "HELLO THIS IS vTime." **(Message scanning powered by Discord AutoMod)**
...
Each detection option features a **Settings** option, indicated by a gear icon `⚙️`. Clicking on this option will reveal a range of settings that you can adjust to optimize the use of vTime Automod for your server.
...
In addition to the detection and action options described above, vTime Automod also includes the following features:
