...
In this section, you will gain a deeper understanding of the vTime commands, their usage, and an example of how to put such commands into action.
...
| /vip whitelist | Whitelist a user to allow access to the vTime dashboard | /vip whitelist [user] |
