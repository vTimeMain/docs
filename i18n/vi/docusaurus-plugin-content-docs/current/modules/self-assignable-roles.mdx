...
[Embed Messages](https://docs.vTime.io/docs/modules/embed) describes how to create and send a message.
...
If your server roles do not appear in the dashboard, move the vTime's role higher in the server roles hierarchy.
